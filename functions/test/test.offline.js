...
describe('Cloud functions', () => {
    ...
    describe('newFile', () => {
        it('should insert data from file in database', async () => {
            ...
            fileStub.withArgs(fileName).returns({createReadStream: () => fs.createReadStream("/home/bollc/IdeaProjects/google/promo-code-enrichment/functions/test/springoffer.csv")});
            ...
            const expected = [
                {assignmentReference: "assignment1"},
                {assignmentReference: "assignment2"}
            ];
    ...
    describe('webhookPOST', () => {
        it('should return ok', () => {
            ...
            myFunctions.webhookPost(req, res);
        })
    });
});